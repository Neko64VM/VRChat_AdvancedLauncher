...
void ConfigManager::LoadSetting(const std::string config_path, const std::string filename)
{
    std::string configPath = config_path + filename;
...
void ConfigManager::SaveSetting(const std::string config_path, const std::string filename)
{
    std::string configPath = config_path + filename;
    std::ifstream file(configPath);
